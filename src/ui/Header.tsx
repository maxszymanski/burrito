    ...
    return (
        <header>
            ...
            <div className="bg-gradient-to-b from-[#9A1E02] to-[#eeb02a] md:bg-headerTablet relative z-0 md:bg-center md:bg-cover md:py-24 xl:pt-44 xl:h-screen xl:bg-headerDesktop 2xl:max-h-[1200px]">
                ...
                <div className=" px-6 pt-8 md:pt-20 xl:pt-40 ">
                    <h1 className="font-frederick text-2xl small:text-4xl text-mywhite leading-normal pb-8 pl-4 relative md:text-7xl lg:text-8xl md:text-center lg:pl-4 xl:pl-8 xl:text-9xl  md:pb-16 md:leading-tight">
                        Odkryj <br />
                        smaki <br />
                        Meksyku
                    </h1>
