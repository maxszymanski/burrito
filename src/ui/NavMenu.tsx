...
function NavMenu() {
    ...
    return (
        <nav className="fixed left-0  bottom-0 w-full border-t-[1px] border-stone-700  max-h-20 xl:top-0 xl:absolute  ">
            <Container>
                <ul
                    className="px-2 pt-1 font-scope text-2xl small:text-3xl text-mywhite flex
			justify-between bg-menu-bg-sm items-center xl:bg-none xl:px-24  "
                >
