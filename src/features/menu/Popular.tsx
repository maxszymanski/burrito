        ...
        <main className="md:px-5 md:pb-8 xl:bg-food md:bg-center md:bg-cover relative">
            ...
            <div className="lg:container lg:mx-auto w-full lg:flex lg:flex-col md:space-y-6 lg:pb-6 relative z-10">
                ...
                <SetCard
                    ...
                    itemTwo={burritoPork}
                    image="./images/doubleChicken.png"
                    imageBig="./images/doubleChickenBig.png"
                />
                <SetCard
                    ...
                    itemOne={tacoChicken}
                    isOverflow={false}
                    image="./images/doubleTaco.png"
                    imageBig="./images/doubleTacoBig.png"
                />
                <SetCard
                    title="Zestaw wegan"
                    itemOne={burritoSoja}
                    itemTwo={tacoVegan}
                    image="./images/doubleVegan.png"
                    imageBig="./images/doubleVeganBig.png"
                    isEnd
                />
            </div>
        </main>
