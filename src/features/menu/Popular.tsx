...
function Popular() {
	...
	return (
		<main className="mb-5">
			<h2 className="text-mywhite text-3xl font-semibold p-6 tracking-widest">Popularne</h2>
			<SetCard title="Zestaw Double burrito" itemOne={burritoChicken} itemTwo={burritoPork} />
			<SetCard title="Zestaw Double taco" itemTwo={tacoPork} itemOne={tacoChicken} isOverflow={false} />
			<SetCard title="Zestaw wegan" itemOne={burritoSoja} itemTwo={tacoVegan} />
		</main>
	)
}
