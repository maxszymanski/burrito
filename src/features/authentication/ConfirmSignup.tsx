...
function ConfirmSignup() {
    ...
    return (
        <section className="w-full min-h-screen bg-menu-bg-sm bg-cover bg-center xl:bg-cart px-6 py-6  ">
            <div className="text-mywhite lg:container lg:mx-auto lg:w-full xl:text-center px-1 ">
                <Logo isHidden={false} />
                ...
                <p className="small:text-lg tracking-wider mb-4 leading-relaxed lg:leading-loose lg:text-xl xl:text-2xl text-center ">
                ...
                <p className="small:text-lg tracking-wider leading-relaxed lg:leading-loose lg:text-xl xl:text-2xl text-center ">
