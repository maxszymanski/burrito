        ...
        <>
            <section className="px-6 lg:container lg:mx-auto text-mywhite w-full pb-24 text-center xl:pb-12 xl:pt-28 2xl:ml-8">
                ...
                <p className="mb-4 lg:mb-6 lg:text-lg">
                    Serdecznie zapraszamy do naszej restauracji Burrito w
                    Krakowie! Znajdziecie nas w samym sercu miasta, gdzie
                    serwujemy najpyszniejsze burrito i inne meksykańskie
                    specjały.
                </p>
                ...
                <div className="py-4 lg:py-8">
                    ...
                    <p className="my-5 text-center lg:text-lg">
                        Bądź na bieżąco z naszymi nowościami i promocjami! Śledź
                        nas na:
                    </p>
